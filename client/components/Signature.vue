        ...
        <div v-if="signatureData.layout.selection === 'Simple'" :style="{'font-family': signatureData.font.family }">
          ...
          <div id="sig-social">
            <a v-for="link in signatureData.links" v-show="link.value !== undefined && link.value !== null && link.value !== ''" :href="link.value">
              <img style="padding-top: 5px; width: 32px; margin-right: 2px; " v-if="link.site === 'Facebook'" src="../assets/img/facebook.png" :alt="link.value">
              <img style="padding-top: 5px; width: 32px; margin-right: 2px;" v-else-if="link.site === 'Linkedin'" src="../assets/img/linkedin.png" :alt="link.value">
              <img style="padding-top: 5px; width: 32px; margin-right: 2px;" v-else-if="link.site === 'Twitter'" src="../assets/img/twitter.png" :alt="link.value">
              <img style="padding-top: 5px; width: 32px; margin-right: 2px;" v-else-if="link.site === 'Github'" src="../assets/img/github.png" :alt="link.value"></a>
          </div>
        </div>
